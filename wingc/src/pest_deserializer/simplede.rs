...
pub struct DeAdapter<H>(pub H);

pub trait SimpleDe<'de>: Sized {
    type Error: serde::de::Error;

    fn adapter(self) -> DeAdapter<Self> {
        DeAdapter(self)
    }
...
impl<'de, H> Deserializer<'de> for DeAdapter<H>
where
    H: SimpleDe<'de>,
{
    type Error = <H as SimpleDe<'de>>::Error;
